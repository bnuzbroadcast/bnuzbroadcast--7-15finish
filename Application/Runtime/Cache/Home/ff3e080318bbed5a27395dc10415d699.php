...
<html>
	...
	<body style="background-color: #f4f4f4;">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="<?php echo U('Home/lanmu/index');?>">往期节目</a></li>
		...
		<div style="margin-top: 60px;">
			<img src="/bnuzbroadcast/Public/img/feichangd.png" width="1200px"class="img-responsive center-block"  />
		</div>
		<div class="tab13">
		...
		<div class="tab14">
			<div class="container" style="background-color: #fff;padding-bottom: 20px;">
				...
				<div class="row">
					<div class="col-md-6">
						<a href="#new">
						<img src="/bnuzbroadcast/Public/img/new.png" class="img-responsive center-block" alt="" /></a>
					</div>
					<div class="col-md-6">
						<a href="#new">
						<img src="/bnuzbroadcast/Public/img/hot.png" class="img-responsive center-block" alt="" /></a>
					</div>
				</div>
				<div style="background-color: #b6e2f0;margin-top: 30px;margin-bottom: 30px;">
					<a name="new"></a>
					<h4 class="tab-h4" style="padding-left: 30px;float: left;">最新最热节目</h4>
					<div class="clear"></div>
				</div>
				<div class="row">
						<?php if(is_array($select)): $i = 0; $__LIST__ = $select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$program): $mod = ($i % 2 );++$i;?><div class="col-sm-3">
							<a href="../Play/index/id/<?php echo ($program["programid"]); ?>" ><img src="/bnuzbroadcast/Public/img/wqjmtb.png" class="img-responsive center-block"/><div style="text-align: center"><p class="tab-p1" ><?php echo ($program["programname"]); ?></p></div></a>
