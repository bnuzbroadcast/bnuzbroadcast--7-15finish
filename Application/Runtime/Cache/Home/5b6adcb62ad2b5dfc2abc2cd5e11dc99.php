					...
					<div class="log-broad">
						<div class="row "  style="margin-top: 20px;">
							<div class="col-md-6 col-md-offset-1 logtitle"  style="margin-top: 30px;"> 
								<span class="tab-h3">用户登陆</span>
							</div>
						</div>
						<div class="row ">
							<div class="col-md-2 col-md-offset-1 log-span  logtitle"><span class="tab-h5">昵 称</span></div>
							<div class="col-md-6 logtitle">
								<input type="text" name="username" id="" value="" class="log-input"/>
							</div>
						</div>
						<div class="row ">
							<div class="col-md-2 col-md-offset-1 log-span  logtitle"><span class="tab-h5">密 码</span></div>
							<div class="col-md-6 logtitle">
								<input type="password" name="userpassword" id="" value="" class="log-input"/>
							</div>
						</div>
						<div class="row" style="text-align: right;">
							<div class="col-md-4 col-md-offset-5">
								<a href="<?php echo U('Home/signup/index');?>"><input type="button" name="" id="" value="注册" class="log-button"/></a>
								<input type="submit" name="" id="" value="登陆" class="log-button"/>
							</div>
						</div>
					</div>
				</form>
