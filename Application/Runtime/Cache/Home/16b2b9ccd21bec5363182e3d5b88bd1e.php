	...
	<!-- 导航 -->
		...
		<div id="myCarousel" class="carousel slide" style="margin-top: 60px;">
			...
			<div class="carousel-inner">
				...
				<div class="item">
					<img src="/bnuzbroadcast/Public/img/lunbo1.png"  alt="第二张">
				</div>
				<div class="item">
		...
		<div class="tab8">
			<div class="container">
				<h2 class="tab-h2" style="margin-bottom: 10px;">Br<span style="border-bottom: 1px solid #333;">and avtiviti</span>es</h2>
				<p class="tab-p" style="text-align: center;">品牌活动</p>
				<div class="row" style="margin-top: 30px;">
					<?php if(is_array($activitylist)): $i = 0; $__LIST__ = array_slice($activitylist,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$activity): $mod = ($i % 2 );++$i;?><div class="col-sm-3" >
						<a href="../activity2/index/id/<?php echo ($activity["activityid"]); ?>">
						<img src="/bnuzbroadcast/<?php echo ($activity["activitysmallpicture"]); ?>" class="img-responsive center-block" /></a>
