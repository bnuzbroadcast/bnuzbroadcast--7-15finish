					...
					<div class="col-md-6">
						<div class="medi">
							<div class="media-heading">
								<img src="/bnuzbroadcast/Public/img/select2.png" class="img-responsive center-block" alt="" />
							</div>
					...
					<div class="col-md-6">
						<div class="media">
							<div class="media-heading" style="text-align: center;">
								<span class="tab-h2">STH U Can’t Miss</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
								<span class="tab-h3">播主：Vincy Frank Walter</span>
								<p class="tab-p"><b>本期配乐：Purple Rain/Historia De Un Amor</b></p>
								<p class="tab-p1"></br></br></br>A Woman with a lot of boyfriends and a man with a lot of girlfriendsLucas Till in“You Belong With Me”</br></br></br></p>
							</div>
