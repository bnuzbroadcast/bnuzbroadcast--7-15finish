			...
			<div style="padding: 5%">
				<table class="simpletable">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($vo["hcommentdate"]); ?></td>
						<td><?php echo ($vo["username"]); ?></td>
						<td><?php echo ($vo["hcommentcontent"]); ?></td>
						<td><?php echo ($vo["hostname"]); ?></td>
						<td><a href="/bnuzbroadcast/index.php/Admin/Hcomment/shanchu/hcommentid/<?php echo ($vo["hcommentid"]); ?>" onclick="return confirm('您确定要删除该留言吗？')">删除</a></td>
